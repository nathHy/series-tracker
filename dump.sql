...
--
-- Table structure for table `list_series`
--
...
CREATE TABLE `list_series` (
  ...
  CONSTRAINT `list_series_ibfk_1` FOREIGN KEY (`list_id`) REFERENCES `list` (`id`),
  CONSTRAINT `list_series_ibfk_2` FOREIGN KEY (`series_id`) REFERENCES `series` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `list_series`
--

LOCK TABLES `list_series` WRITE;
/*!40000 ALTER TABLE `list_series` DISABLE KEYS */;
/*!40000 ALTER TABLE `list_series` ENABLE KEYS */;
UNLOCK TABLES;
